...
class BrokerOrderTicketTest extends TestCase
{
    ...
    public function test_ibkr_bracket_ticket_formats_trading_view_plan(): void
    {
        ...
        $this->assertSame('34 stuks', $ticket['rows'][2]['value']);
        $this->assertSame('34', $ticket['rows'][2]['copy_value']);
        $this->assertSame('$71.80', $ticket['rows'][3]['value']);
        $this->assertSame('71.80', $ticket['rows'][3]['copy_value']);
        $this->assertSame('Limit Prijs (Max Inkoop)', $ticket['rows'][4]['label']);
        $this->assertSame('$71.95', $ticket['rows'][4]['value']);
        $this->assertSame('71.95', $ticket['rows'][4]['copy_value']);
        $this->assertSame('$78.90', $ticket['rows'][5]['value']);
        $this->assertSame('78.90', $ticket['rows'][5]['copy_value']);
        $this->assertStringContainsString('17 stuks', $ticket['rows'][5]['hint']);
        $this->assertStringContainsString('100%', $ticket['rows'][5]['hint']);
        $this->assertStringContainsString('wijzig daarna', $ticket['rows'][5]['hint']);
        $this->assertSame('$68.25', $ticket['rows'][6]['value']);
        $this->assertSame('68.25', $ticket['rows'][6]['copy_value']);
